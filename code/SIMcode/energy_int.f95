...
!     Revised 6-22-04
      ...
      SUBROUTINE energy_int(R,AB,NP,N,NT,NBIN, &
      V,CHI,KAP,LBOX,DEL,ECHI,EKAP)
...
!     Simulation input variables
      ...
      DOUBLE PRECISION ECOM,ECHI,EKAP
      DOUBLE PRECISION BAB,B     
      INTEGER IX(2),IY(2),IZ(2)
      INTEGER IB
      INTEGER NBINX
      DOUBLE PRECISION UI(3),BI
...
!                     PRINT*, '  In energy_int IB = ', IB, ' INDBIN = ', INDBIN, ' WTOT = ', WTOT
                     if (AB(IB).EQ.1) then
...
!      PRINT*, ' IN energy_int PHIA = ', PHIA(20)
